...
<div class="contact-container">
    ...
    <form id="contactForm" action="formulairedecontacte-fr.php" method="POST">
        <div class="form-group">
            <div class="half">
                <label for="first_name">Votre Prénom</label>
                <input type="text" id="first_name" name="first_name" placeholder="Veuillez entrer votre prénom ici" 
                value="<?php echo isset($_SESSION['prenom']) ? htmlspecialchars($_SESSION['prenom']) : ''; ?>" required>
            </div>
            <div class="half">
                <label for="last_name">Votre Nom</label>
                <input type="text" id="last_name" name="last_name" placeholder="Veuillez entrer votre nom ici" 
        ...
        <div class="form-group">
            <div class="full">
                ...
                <textarea id="comment" name="comment" rows="4" placeholder="Entrez votre message..." required></textarea>
            </div>
        </div>
    ...
    <div class="contact-container1">
        <div class="contact-section">
            <div class="contact-info">
                <h3><i class="fas fa-envelope"></i>Courriel</h3>
                <p><?php echo fetchContent('contact_fr', 'email'); ?></p>
                <br /><br />
                <h3><i class="fas fa-phone-alt"></i>Téléphone</h3>
                <p><?php echo fetchContent('contact_fr', 'phone'); ?></p>
                <br /><br />
                <h3 style="margin-bottom: 0.01rem;"><i class="fas fa-clock"></i>Horaires</h3>
                <p style="text-align: center; white-space: pre-line; line-height: 2.5; margin-top: 0.1rem;">
                    <?= htmlspecialchars(fetchContent('contact_fr', 'horaire')); ?>
                </p>
            </div>
        </div>
    </div>
...
document.getElementById("contactForm").addEventListener("submit", function(event) {
    ...
    fetch("formulairedecontacte-fr.php", {
        method: "POST",
        body: formData
    })
    ...
    .then(data => {
        ...
        if (data.status === "success") {
            showPopup("✅ Votre message a été envoyé!");
