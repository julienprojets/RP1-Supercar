        ...
        const carCard = `<div class="col-md-4 mb-4">
            <div class="card shadow-sm">
                ...
                <div class="card-body">
                    ...
                    <a href="Explore-fr.php?car=${formattedModel}" class="btn btn-crimson w-100">En Savoir Plus</a>
                </div>
            </div>
        </div>`;
...
<main class="bg-light pt-4">
    <h2 class="text-center mb-4 txt-color fw-bold">Nos Voitures</h2>
    <div class="container mt-5 x2">
        <div class="row">
            <div class="col-md-2 sidefilter">
                <h4 class="text-center txt-color mb-3 mt-2">Recherche</h4>
                <div class="mb-3">
                ...
                <div class="mb-3">
                    <select id="filterType" class="form-select x3" onchange="filterCars()">
                        <option value="">Types de Carrosserie</option>
                    </select>
                </div>
                <!-- <div class="col-12 d-flex gap-2 mb-3"> -->
                    <button class="btn btn-crimson w-100 mb-2 mt-2" onclick="clearFilters()">Retirer les Filtres</button>
                <!-- </div> -->
                <div class="dropdown mt-3">
                    ...
                    <ul class="dropdown-menu dmenu">
                        <li><a class="dropdown-item" href="#" onclick="sortCars('name', false)">Nom (A-Z)</a></li>
                        <li><a class="dropdown-item" href="#" onclick="sortCars('name', true)">Nom (Z-A)</a></li>
                        <li><a class="dropdown-item" href="#" onclick="sortCars('price', true)">Prix (moins cher au plus cher)</a></li>
                        <li><a class="dropdown-item" href="#" onclick="sortCars('price', false)">Prix (plus cher au moins cher)</a></li>
                    </ul>
                </div>
            </div>
        </div>
