...
if ($result->num_rows > 0) {
    ...
    if ($password === $row['password']) {  // Direct comparison (no hashing)
        ...
        echo "Mot de passe incorrect. <a href='loginpage-fr.php'>Veuillez réessayer</a>";

    }
} else {
    echo "Aucun utilisateur n'a été trouvé avec ce nom. <a href='loginpage-fr.php'>Veuillez réessayer</a>";
